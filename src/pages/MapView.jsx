      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div>
          ...
          <p className="text-slate-600 text-sm mt-1">
            Interactive multi-hazard GIS view using AASHRAY AI/ML risk data.
          </p>
            ...
            {selectedHabitation?(
              <div className="space-y-4">
                ...
                <div className="space-y-2.5 text-xs">
                  ...
                  <div className="flex justify-between py-1 border-b border-slate-100">
                    ...
                    <span className="font-bold text-red-600 text-sm">
                      {selectedHabitation.risk_score ?? 'N/A'} / 100
                    </span>
                  ...
                  <div className="flex justify-between py-1 border-b border-slate-100">
                    ...
                    <span className="font-bold text-slate-800">
                      {selectedHabitation.population==null
                        ?'N/A'
                  ...
                  <div className="flex justify-between py-1 border-b border-slate-100">
                    ...
                    <span className="font-semibold text-slate-700">
                      {selectedHabitation.district||'N/A'}
                    </span>
                ...
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                  ...
                  {selectedHabitation.hazards?(
                    <div className="space-y-1.5 text-[11px]">

                      <div className="flex justify-between">
                        <span>Coastal</span>
                        <strong>
                          {selectedHabitation.hazards.coastal!=null
                            ?(selectedHabitation.hazards.coastal*100).toFixed(1)
                            :'N/A'
                          }
                        </strong>
                      </div>
                      ...
                      <div className="flex justify-between">
                        <span>Flood</span>
                        <strong>
                          {selectedHabitation.hazards.flood!=null
                            ?(selectedHabitation.hazards.flood*100).toFixed(1)
                            :'N/A'
                          }
                        </strong>
                      </div>
                      ...
                      <div className="flex justify-between">
                        <span>Cyclone</span>
                        <strong>
                          {selectedHabitation.hazards.cyclone!=null
                            ?(selectedHabitation.hazards.cyclone*100).toFixed(1)
                            :'N/A'
                          }
                        </strong>
                      </div>
                      ...
                      <div className="flex justify-between">
                        <span>Rainfall</span>
                        <strong>
                          {selectedHabitation.hazards.rainfall!=null
                            ?(selectedHabitation.hazards.rainfall*100).toFixed(1)
                            :'N/A'
                          }
                        </strong>
                      </div>
